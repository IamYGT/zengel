...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['category_name'])) {
        $valid = 0;
        $error_message .= "Kategori Adı boş olamaz<br>";
    } else {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO tbl_category (category_name,category_slug,meta_title,meta_description) VALUES (?,?,?,?)");
		$statement->execute(array($_POST['category_name'],$category_slug,$_POST['meta_title'],$_POST['meta_description']));
