...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Dosya başarıyla güncellendi.';
    }
}
?>
<?php
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
				            <label for="" class="col-sm-2 control-label">Mevcut Dosya</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Yeni Dosya <span>*</span></label>
