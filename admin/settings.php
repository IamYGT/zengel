...
if(isset($_POST['form1'])) {
    ...
    if($path == '') {
    	$valid = 0;
        $error_message .= 'Bir logo seçmelisiniz<br>';
    } else {
...
if(isset($_POST['form2'])) {
    ...
    if($path == '') {
    	$valid = 0;
        $error_message .= 'Bir favicon seçmelisiniz<br>';
    } else {
        $ext = pathinfo( $path, PATHINFO_EXTENSION );
        $file_name = basename( $path, '.' . $ext );
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
    ...
    if($valid == 1) {
		...
		$statement->execute(array($final_name));
        $success_message = 'Favicon başarıyla güncellendi.';
...
if(isset($_POST['form3'])) {
	...
	$success_message = 'Genel içerik ayarları başarıyla güncellendi.';
...
if(isset($_POST['form5'])) {
	...
	$success_message = 'Sidebar ayarları başarıyla güncellendi.';
}
if(isset($_POST['form6'])) {
	// updating the database
	$statement = $pdo->prepare("UPDATE tbl_settings SET meta_title_home=?, meta_description_home=? WHERE id=1");
	$statement->execute(array($_POST['meta_title_home'],$_POST['meta_description_home']));
	$success_message = 'Ana Sayfa Meta ayarları başarıyla güncellendi.';
}
if(isset($_POST['form_other'])) {
	...
	$success_message = 'Diğer ayarlar başarıyla güncellendi.';
}
    ...
    if($valid == 1) {
        if($path != '') {
            ...
            foreach ($result as $row) {
                ...
                unlink('../assets/uploads/'.$about_photo);
            }
            // updating the data
            $final_name = 'about'.'.'.$ext;
            move_uploaded_file( $path_tmp, '../assets/uploads/'.$final_name );
            // updating the database
            $statement = $pdo->prepare("UPDATE tbl_settings SET heading_home=?, about_photo=?, text_home=?, video_home=?, url_home=? WHERE id=1");
            $statement->execute(array($_POST['heading_home'],$final_name,$_POST['text_home'],$_POST['video_home'],$_POST['url_home']));
        } else {
            // updating the database
            $statement = $pdo->prepare("UPDATE tbl_settings SET heading_home=?, text_home=?, video_home=?, url_home=? WHERE id=1");
            $statement->execute(array($_POST['heading_home'],$_POST['text_home'],$_POST['video_home'],$_POST['url_home']));
        }
        $success_message = 'Ana Sayfa Kurumsal ayarları başarıyla güncellendi.';
...
if(isset($_POST['form_newsletter'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Bülten Verileri başarıyla güncellendi.';
...
if(isset($_POST['form_banner_search'])) {
    ...
    if($valid == 1) {
        ...
        $statement->execute(array($final_name));
        $success_message = 'Arama Sayfası Başlığı başarıyla güncellendi.';
...
if(isset($_POST['form_banner_category'])) {
    ...
    if($valid == 1) {
        ...
        $statement->execute(array($final_name));
        $success_message = 'Kategori Sayfası Başlığı başarıyla güncellendi.';
...
if(isset($_POST['form_home_service'])) {
    ...
    $success_message = 'Hizmet Bölümü başarıyla güncellendi.';
}
if(isset($_POST['form_home_team_member'])) {
    ...
    $success_message = 'Personel Bölümü başarıyla güncellendi.';
}
if(isset($_POST['form_home_testimonial'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Müşteri Yorumları Verileri başarıyla güncellendi.';
...
if(isset($_POST['form_home_news'])) {
    ...
    $success_message = 'Blog Verileri başarıyla güncellendi.';
}
if(isset($_POST['form_home_partner'])) {
    ...
    $success_message = 'Markalar Verileri başarıyla güncellendi.';
}
if(isset($_POST['form_home_counter'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Sayaç Verileri başarıyla güncellendi.';
...
if(isset($_POST['form_color'])) {
    ...
    $success_message = 'Tema Renk ayarları başarıyla güncellendi.';
}
?>
		...
		<div class="col-md-12">							
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_3" data-toggle="tab">Footer & İletişim</a></li>
						<li><a href="#tab_4" data-toggle="tab">Email Ayarları</a></li>
						<li><a href="#tab_5" data-toggle="tab">Blog</a></li>
						<li><a href="#tab_6" data-toggle="tab">Ana Sayfa</a></li>
						<li><a href="#tab_9" data-toggle="tab">Banner</a></li>
                        <li><a href="#tab_8" data-toggle="tab">Diğer</a></li>
					</ul>
					<div class="tab-content">
          				<div class="tab-pane active" id="tab_1">
          					...
          					<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
							            <label for="" class="col-sm-2 control-label">Yeni Logo</label>
							            <div class="col-sm-6" style="padding-top:6px;">
          				...
          				<div class="tab-pane" id="tab_2">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
							            <label for="" class="col-sm-2 control-label">Mevcut Favicon</label>
							            <div class="col-sm-6" style="padding-top:6px;">
							                <img src="../assets/uploads/<?php echo $favicon; ?>" class="existing-photo" style="height:40px;">
							            </div>
							        </div>
									<div class="form-group">
							            <label for="" class="col-sm-2 control-label">Yeni Favicon</label>
							            <div class="col-sm-6" style="padding-top:6px;">
          				...
          				<div class="tab-pane" id="tab_4">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
                                        <label for="" class="col-sm-2 control-label">E-posta Gönder</label>
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="send_email_from" value="<?php echo $send_email_from; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">E-Posta Al</label>
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="receive_email_to" value="<?php echo $receive_email_to; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">SMTP Durumu:</label>
                                        <div class="col-sm-5">
                                            <select name="smtp_active" class="form-control">
                                                <option value="Yes" <?php if($smtp_active=='Yes') {echo 'selected';} ?>>Aktif</option>
                                                <option value="No" <?php if($smtp_active=='No') {echo 'selected';} ?>>Pasif</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <select name="smtp_ssl" class="form-control">
                                                <option value="Yes" <?php if($smtp_ssl=='Yes') {echo 'selected';} ?>>Aktif</option>
                                                <option value="No" <?php if($smtp_ssl=='No') {echo 'selected';} ?>>Pasif</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">SMTP K.Adı</label>
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="smtp_username" value="<?php echo $smtp_username; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">SMTP Şifre</label>
                                        <div class="col-sm-5">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form_email">Güncelle</button>
										</div>
									</div>
								</div>
							</div>
          				...
          				<div class="tab-pane" id="tab_6">							
							<h3>Ana Sayfa SEO Meta</h3>
          					<form class="form-horizontal" action="" method="post">
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">SEO Meta Title </label>
										<div class="col-sm-9">
											<input type="text" name="meta_title_home" class="form-control" value="<?php echo $meta_title_home ?>">
										</div>
									</div>			
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">SEO Meta Description </label>
										<div class="col-sm-9">
							...
							<h3>Ana Sayfa Kurumsal</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Kurumsal Başlık </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="heading_home" class="form-control" value="<?php echo $heading_home; ?>">
                                        </div>
                                    </div>                                
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Kurumsal Text</label>
                                        <div class="col-sm-8">
                                            <textarea name="text_home" class="form-control" cols="30" rows="10" style="height: 120px;"><?php echo $text_home; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Kurumsal Buton URL </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="url_home" class="form-control" value="<?php echo $url_home; ?>">
                                        </div>
                                    </div>									
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Video URL </label>
                                        <div class="col-sm-6">
                                            <input type="text" name="video_home" class="form-control" value="<?php echo $video_home; ?>">
                                        </div>
                                    </div> 									
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Mevcut Arka Plan</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="../assets/uploads/<?php echo $about_photo; ?>" class="existing-photo" style="height:180px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Yeni Arka Plan</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_home_about">Güncelle</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            </form>							
							<h3>Ana Sayfa Hizmetler</h3>
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
	                                <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-6" style="padding-top:7px;">
											<select name="home_status_service" class="form-control" style="width:auto;">
                                                <option value="Show" <?php if($home_status_service == 'Show') {echo 'selected';} ?>>Göster</option>
                                                <option value="Hide" <?php if($home_status_service == 'Hide') {echo 'selected';} ?>>Gizle</option>
                                            </select>
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form_home_service">Güncelle</button>
										</div>
									</div>
                                </div>
                            </div>
                            </form>
                            <h3>Ana Sayfa Personel</h3>
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
	                                <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-6" style="padding-top:7px;">
											<select name="home_status_team_member" class="form-control" style="width:auto;">
                                                <option value="Show" <?php if($home_status_team_member == 'Show') {echo 'selected';} ?>>Göster</option>
                                                <option value="Hide" <?php if($home_status_team_member == 'Hide') {echo 'selected';} ?>>Gizle</option>
                                            </select>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-6" style="padding-top:7px;">
											<select name="counter_status" class="form-control" style="width:auto;">
                                                <option value="Show" <?php if($counter_status == 'Show') {echo 'selected';} ?>>Göster</option>
                                                <option value="Hide" <?php if($counter_status == 'Hide') {echo 'selected';} ?>>Gizle</option>
                                            </select>
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form_home_counter">Güncelle</button>
										</div>
									</div>
                                </div>
                            </div>
                            </form>
                            <h3>Ana Sayfa M. Yorumları</h3>
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
	                                <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-6" style="padding-top:7px;">
											<select name="home_status_testimonial" class="form-control" style="width:auto;">
                                                <option value="Show" <?php if($home_status_testimonial == 'Show') {echo 'selected';} ?>>Göster</option>
                                                <option value="Hide" <?php if($home_status_testimonial == 'Hide') {echo 'selected';} ?>>Gizle</option>
                                            </select>
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form_home_testimonial">Güncelle</button>
										</div>
									</div>
                                </div>
                            </div>
                            </form>
                            <h3>Ana Sayfa Blog</h3>
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
	                                <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-6" style="padding-top:7px;">
											<select name="home_status_news" class="form-control" style="width:auto;">
                                                <option value="Show" <?php if($home_status_news == 'Show') {echo 'selected';} ?>>Göster</option>
                                                <option value="Hide" <?php if($home_status_news == 'Hide') {echo 'selected';} ?>>Gizle</option>
                                            </select>
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form_home_news">Güncelle</button>
										</div>
									</div>
                                </div>
                            </div>
                            </form>
                            <h3>Ana Sayfa Markalar</h3>
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
	                                <div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-6" style="padding-top:7px;">
											<select name="home_status_partner" class="form-control" style="width:auto;">
                                                <option value="Show" <?php if($home_status_partner == 'Show') {echo 'selected';} ?>>Göster</option>
                                                <option value="Hide" <?php if($home_status_partner == 'Hide') {echo 'selected';} ?>>Gizle</option>
                                            </select>
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form_home_partner">Güncelle</button>
										</div>
									</div>
                                </div>
                            </div>
                            </form>
							<h3>Ana Sayfa E-bülten</h3>
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                            <div class="box box-info">
                                <div class="box-body">
                                 <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Bülten Text</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <select name="newsletter_status" class="form-control" style="width:auto;">
                                                <option value="Show" <?php if($newsletter_status == 'Show') {echo 'selected';} ?>>Göster</option>
                                                <option value="Hide" <?php if($newsletter_status == 'Hide') {echo 'selected';} ?>>Gizle</option>
                                            </select>
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_newsletter">Güncelle</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
          				...
          				<div class="tab-pane" id="tab_8">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
										...
										<div class="col-sm-2">
											<select name="mod_rewrite" class="form-control" style="width:100%;">
												<option value="Off" <?php if($mod_rewrite == 'Off'){echo 'selected';} ?>>Aktif</option>
												<option value="On" <?php if($mod_rewrite == 'On'){echo 'selected';} ?>>Pasif</option>
											</select>
										</div>
									</div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <select name="preloader" class="form-control" style="width:100%;">
                                                <option value="On" <?php if($preloader == 'On'){echo 'selected';} ?>>Aktif</option>
                                                <option value="Off" <?php if($preloader == 'Off'){echo 'selected';} ?>>Pasif</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Editör Seçin </label>
                                        <div class="col-sm-2">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Firma Adı </label>
                                        <div class="col-sm-4">
          				...
          				<div class="tab-pane" id="tab_9">
          					<table class="table table-bordered">          						
                                <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Mevcut Hizmet Sayfası Banner</h4>
                                        <p>
                                            <img src="<?php echo BASE_URL.'assets/uploads/'.$banner_search; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Yeni Hizmet Sayfası Banner</h4>
                                        Fotoğraf Seç<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Değiştir" style="margin-top:10px;" name="form_banner_search">
                                    </td>
                                    </form>
                                </tr>
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Mevcut Kategori Sayfası Banner</h4>
                                        <p>
                                            <img src="<?php echo BASE_URL.'assets/uploads/'.$banner_category; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Yeni Kategori Sayfası Banner</h4>
                                        Fotoğraf Seç<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Değiştir" style="margin-top:10px;" name="form_banner_category">
                                    </td>
                                    </form>
                                </tr>
          					</table>
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Renk </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_color">Güncelle</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
