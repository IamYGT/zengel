...
if(isset($_POST['form1'])) {
	...
	$success_message = 'Sosyal Medya URL başarıyla güncellendi.';
}
?>
		...
		<div class="col-md-12">
			<form class="form-horizontal" action="" method="post">
				<div class="box box-info">
					<div class="box-body">						
						<p style="padding-bottom: 20px;">Web sitenizde bir sosyal medya iconu göstermek istemiyorsanız, giriş alanını boş bırakmanız yeterlidir.</p>
