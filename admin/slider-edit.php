...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="slider.php" class="btn btn-primary btn-sm">Slider Listele</a>
	</div>
</section>
<?php
$statement = $pdo->prepare("SELECT * FROM tbl_slider WHERE id=?");
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Buton Text </label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Konum </label>
							<div class="col-sm-6">
								<select name="position" class="form-control">
									<option value="Left" <?php if($position == 'Left') {echo 'selected';} ?>>Sol</option>
									<option value="Center" <?php if($position == 'Center') {echo 'selected';} ?>>Orta</option>
									<option value="Right" <?php if($position == 'Right') {echo 'selected';} ?>>Sağ</option>
								</select>
							</div>
						</div>      
				        <div class="form-group">
